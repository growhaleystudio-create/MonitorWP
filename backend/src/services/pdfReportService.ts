...
export async function generateClientPdfReport(siteId: number): Promise<Buffer> {
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fillColor('#ffffff').fontSize(18).font('Helvetica-Bold').text('WhalePod', 55, 52);
      ...
      doc.fontSize(8).font('Helvetica').fillColor('#94a3b8').text(
        'Generated by WhalePod — Centralized Performance, Security, and SEO Management Dashboard',
        40, 780, { align: 'center' }
      );
