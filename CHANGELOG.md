...
- **🛡️ Security & WAF Threat Center (`/security`)**: Centralized WAZUH Lite SIEM security dashboard featuring live incident event streams (SQLi, XSS, Brute Force, FIM) and node hardening (SCA) assessment scores.
